...
def main():
    ...
    gluPerspective(60, (display[0] / display[1]), .1, 50)
    ...
    while running:
        ...
        if game_over == False:
            ...
            draw_text(150, 550, f'{red_paddle_score}', 128)
            draw_text(1000, 550, f'{blue_paddle_score}', 128)
            
        if red_paddle_score == 6:
            draw_text(280, 650, 'Game Over! Player 1 Wins!', 64)
            game_over = True
        if blue_paddle_score == 6:
            draw_text(280, 650, 'Game Over! Player 2 Wins!', 64)
            game_over = True
